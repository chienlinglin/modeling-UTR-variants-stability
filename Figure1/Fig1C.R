...
df_plot_utr5 <- read_xlsx(file.path(getwd(), "fig_data_code_GR", "fig_1C.xlsx"), sheet = "UTR5")
df_plot_utr3 <- read_xlsx(file.path(getwd(), "fig_data_code_GR", "fig_1C.xlsx"), sheet = "UTR3")
